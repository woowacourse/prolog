...
public class AbilityDocumentation extends NewDocumentation {
    ...
    @Test
    void 역량_수정() {
        doNothing().when(abilityService).updateAbility(any(), any(), any());
    ...
    private static final List<HierarchyAbilityResponse> ABILITY_RESPONSES = Lists.newArrayList(
        new HierarchyAbilityResponse(
            1L,
            "부모 역량 이름",
            "부모 역량 설명",
            "#001122",
