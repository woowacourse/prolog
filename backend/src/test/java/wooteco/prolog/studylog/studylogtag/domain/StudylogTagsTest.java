package wooteco.prolog.studylog.studylogtag.domain;
...
public class StudylogTagsTest {
    ...
    void setUp() {
        ...
        this.studylogTags.add(Collections.singletonList(워니_스터디로그태그));
    }
    ...
    void addTest() {
        ...
        // then
        assertThat(this.studylogTags.getValues()).containsExactlyInAnyOrder(this.워니_스터디로그태그, 레벨1_스터디로그태그);
    }
    ...
    void updateTest() {
        ...
        // then
        assertThat(this.studylogTags.getValues()).containsExactlyInAnyOrder(포비_스터디로그태그, 레벨1_스터디로그태그);
    }
}
