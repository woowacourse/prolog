...
class PopularStudylogServiceTest {
    ...
    void findPopularStudylogsWithoutLogin() {
        // given
        insertStudylogs(member1, studylog1, studylog2, studylog3, studylog4);
    ...
    void findPopularStudylogsWithLogin() {
        ...
        studylogService.retrieveStudylogById(loginMember2, studylogResponse1.getId());
        ...
        studylogService.retrieveStudylogById(loginMember2, studylogResponse4.getId());
