...
class PostServiceTest extends ServiceTest {
    ...
    private static final String POST4_TITLE = "이것은 제목";
    ...
    void setUp() {
        ...
        MissionResponse missionResponse1 = missionService.create(
            new MissionRequest("자동차 미션", level1.getId()));
        MissionResponse missionResponse2 = missionService.create(
            new MissionRequest("수동차 미션", level2.getId()));
    ...
    void updatePostTest() {
        ...
        assertThat(expectedResult.getId()).isEqualTo(expectedSearchedResult.getId());
        assertThat(expectedResult.getTitle()).isEqualTo(expectedSearchedResult.getTitle());
