...
public class StudylogSessionController {
    ...
    @MemberOnly
    public ResponseEntity<Void> updateStudylogSession(@AuthMemberPrincipal LoginMember member, @PathVariable Long id, @RequestBody StudylogSessionRequest studylogSessionRequest) {
    ...
    @MemberOnly
    public ResponseEntity<Void> updateStudylogMissions(@AuthMemberPrincipal LoginMember member, @PathVariable Long id, @RequestBody StudylogMissionRequest studylogMissionRequest) {
