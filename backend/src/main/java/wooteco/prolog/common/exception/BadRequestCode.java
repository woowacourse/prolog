...
public enum BadRequestCode {
    ...
    STUDYLOG_CONTENT_NULL_OR_EMPTY(2001, "글 내용은 공백일 수 없습나다.", StudylogContentNullOrEmptyException.class),
    STUDYLOG_TITLE_NULL_OR_EMPTY(2002, "글 제목은 공백일 수 없습나다.", StudylogTitleNullOrEmptyException.class),
