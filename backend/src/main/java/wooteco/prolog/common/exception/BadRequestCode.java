...
public enum BadRequestCode {
    ...
    ARTICLE_NOT_FOUND_EXCEPTION(12001, "아티클을 찾을 수 없습니다.",ArticleNotFoundException.class),
    INVALID_ARTICLE_AUTHOR_EXCEPTION(12002, "아티클 작성자가 아닙니다.", InvalidArticleAuthorException.class);
