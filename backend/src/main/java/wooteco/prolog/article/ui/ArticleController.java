...
public class ArticleController {
    ...
    @PostMapping
    public ResponseEntity<Void> createArticles(final ArticleRequest articleRequest,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateArticle(final ArticleRequest articleRequest,
                                              @AuthMemberPrincipal final LoginMember member,
