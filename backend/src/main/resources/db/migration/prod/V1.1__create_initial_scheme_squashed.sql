...
(
    group_id
) references prolog.member_group
(
    id
)
    ) ENGINE = InnoDB
...
(
    ...
    null,
    constraint
    FK_STUDYLOG_TEMP_TAG_STUDYLOG_TEMP
    foreign
    key
(
    studylog_temp_id
) references prolog.studylog_temp
(
    id
)
    on delete cascade,
